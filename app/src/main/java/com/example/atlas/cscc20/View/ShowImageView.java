...
import com.example.atlas.cscc20.Activity.HistoryPlayActivity;
import com.example.atlas.cscc20.Bean.pointBean;
...
public class ShowImageView extends View {
	...
	public ShowImageView(Context context, int width, int height) {//构造方法
		super(context);
		this.width = width;
		this.height = height ;
	...
	public ShowImageView(Context context, AttributeSet attrs, int width, int height) {//构造方法
		super(context, attrs);
		this.width = width;
		this.height = height;
		this.context=context;
	...
	void init() {
		...
		back_bitmap = PicTool.ChangePicSize(HistoryPlayActivity.picInfo.new_bitmap);
		temp_bitmap= PicTool.ChangePicSize(HistoryPlayActivity.picInfo.old_bitMap);
